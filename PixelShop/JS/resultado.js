document.addEventListener("DOMContentLoaded", () => {
  ...
  if (navUsuario) {
    ...
    if (usuario) {
      ...
      navUsuario.innerHTML = `
        ...
        <a href="/register.html"><img src="/assets/Iconos/icono-registrar.png" alt="Registro" class="icono">Registrar cuenta</a>
      `;
    }
  }
  ...
  // --- Código para resultados de búsqueda (si aplica en esta página) ---
